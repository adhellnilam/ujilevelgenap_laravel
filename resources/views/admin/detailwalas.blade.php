                    ...
                    <div class="profile-info">
                        ...
                        <div class="profile-details">
                            <div class="profile-name px-3 pt-2">
                                <h4 class="text-primary mb-0">{{ $walas->name }}</h4>
                                <p>HomeRoom Teacher</p>
                            </div>
                            <div class="profile-email px-2 pt-2">
                                <h4 class="text-muted mb-0"><a href="/cdn-cgi/l/email-protection"
                                        class="_cf_email_"
                                        data-cfemail="670e09010827021f060a170b024904080a">{{ $walas->userid->email }}</a>
                                </h4>
                                <p>Email</p>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="profile-statistics">
                                <div class="text-center">
                                    <div class="row">
                                        <div class="col">
                                            <h5 class="m-b-0">{{ $walas->ttl }}</h5><span>ttl</span>
                                        </div>
                                        <div class="col">
                                            <h6 class="m-b-0">{{ $walas->nipd }}</h6><span>nipd</span>
                                        </div>
                                        <div class="col">
                                        </div>
                                    </div>
