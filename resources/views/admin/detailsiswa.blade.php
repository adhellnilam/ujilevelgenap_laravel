                    ...
                    <div class="profile-info">
                        ...
                        <div class="profile-details">
                            <div class="profile-name px-3 pt-2">
                                <h4 class="text-primary mb-0">{{ $siswa->name }}</h4>
                                <p>student</p>
                            </div>
                            <div class="profile-email px-2 pt-2">
                                <h4 class="text-muted mb-0"><a href="/cdn-cgi/l/email-protection"
                                        class="_cf_email_"
                                        data-cfemail="670e09010827021f060a170b024904080a">{{ $siswa->userid->email }}</a>
                                </h4>
                                <p>Email</p>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="profile-statistics">
                                <div class="text-center">
                                    <div class="row">
                                        <div class="col">
                                            <h5 class="m-b-0">{{ $siswa->ttl }}</h5><span>ttl</span>
                                        </div>
                                        <div class="col">
                                            <h6 class="m-b-0">{{ $siswa->kelas5->name }}</h6><span>kelas</span>
                                        </div>
                                        <div class="col">
                                        </div>
                                    </div>
                                    <div class="mt-4">
                                        <a href="javascript:void(0);"
                                            class="btn btn-primary mb-1 mr-1">Follow</a>
                                        <a href="javascript:void(0);" class="btn btn-primary mb-1"
                                            data-toggle="modal" data-target="#sendMessageModal">Send
                                            Message</a>
                                    </div>
                                </div>
                                <!-- Modal -->
                                            ...
                                            <div class="modal-body">
                                                <form class="comment-form">
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                <label class="text-black font-w600">Name
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                <label class="text-black font-w600">Email
                                                                    <span class="required">*</span></label>
                                                                <input type="text" class="form-control"
                                ...
                                <div id="my-posts" class="tab-pane fade active show">
                                    <div class="my-post-content pt-3">
                                        <div class="post-input">
                                            ...
                                            <a href="javascript:void(0);" class="btn btn-primary light px-3"
                                            ...
                                            <a href="javascript:void(0);"
                                                class="btn btn-primary light mr-1 px-3" data-toggle="modal"
                                                data-target="#cameraModal"><i class="fa fa-camera m-0"></i>
                                            </a>
                                            <!-- Modal -->
                                        ...
                                        <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                            <img src=" {{ asset('././images/ppwa.jpg') }}" alt="" class="img-fluid w-100">
                                ...
                                <div id="about-me" class="tab-pane fade">
                                    ...
                                    <div class="profile-personal-info">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-9 col-7"><span><a
                                                        href="/cdn-cgi/l/email-protection"
                                                        class="_cf_email_"
                                                        data-cfemail="a9ccd1c8c4d9c5cce9ccd1c8c4d9c5ccc587cac6c4">[email&#160;protected]</a></span>
                                            </div>
                                        </div>
                                        <div class="row mb-2">
                                            <div class="col-sm-3 col-5">
